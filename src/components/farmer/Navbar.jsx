...
const isProfileActive = ["/profile", "/farmer/EditProfile", "/farmer/MyAddress","/farmer/Appearance","/farmer/Feedback","/farmer/Complaint","/farmer/Settings","/farmer/Logout","/OrderHistory"].includes(pathname);
